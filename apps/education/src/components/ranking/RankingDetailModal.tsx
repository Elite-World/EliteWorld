            ...
            >
                ...
                <div className="absolute bottom-0 left-0 w-full p-6 sm:p-8 bg-gradient-to-t from-black/60 to-transparent">
                  <div className="flex flex-col sm:flex-row sm:items-end gap-5">
                    ...
                    <div className="flex-1 text-white">
                      <h2 className="text-2xl sm:text-4xl font-bold tracking-tight mb-2 leading-tight">
                        {university.name}
                      </h2>
              ...
              <div className="flex-1 overflow-y-auto p-6 sm:p-8 custom-scrollbar">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                  {/* Left Column: Stats & Quick Info (4/12) */}
                    ...
                    {university.stats &&
                      university.stats.filter((s) => s.type === 'statistic')
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          {university.stats
                            .filter((s) => s.type === 'statistic')
                            .slice(0, 4)
                            .map((stat, idx) => (
                              <div
                                key={idx}
                                className="p-3 bg-gray-50 dark:bg-zinc-800/50 rounded-xl border border-gray-100 dark:border-zinc-700 text-center"
                              >
                                <div
                                  className="text-xs text-gray-500 uppercase font-semibold mb-1 truncate"
                                  title={stat.label}
                                >
                                  {stat.label}
                                </div>
                  ...
                  <div className="md:col-span-8 space-y-8">
                    ...
                    <section>
                      <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                        <Info className="w-5 h-5 text-blue-500" /> About the
                        University
                      </h3>
                      <div className="text-gray-600 dark:text-gray-300 leading-relaxed whitespace-pre-wrap text-[15px] space-y-4">
