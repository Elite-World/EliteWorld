...
function HeroBackground({ mode, backgroundImage }: { mode: 'main' | 'page'; backgroundImage?: string }) {
  ...
  const bgSrc = backgroundImage || imageUrl || (mode === 'main' ? siteConfig.ogImage : null);
    ...
    <>
      ...
      <div className={cn(
          ...
          mode === 'main' 
            ...
            : "bg-gradient-to-r from-blue-600 to-purple-600" // Slightly different gradient for pages
      )} />
