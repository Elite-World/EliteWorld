...
const socialLinks = [
  { icon: 'FaLinkedin' as const, href: siteConfig.social.linkedin },
  { icon: 'FaTwitter' as const, href: siteConfig.social.twitter },
...
export function HomePage({ 
  ...
  const isDark = useThemeStore((state) => state.isDark);
  const { Card, Article: ArticleCard } = themes.ios.components;
  ...
  */
  ...
  return (
    <div className="min-h-screen">
      ...
      <section id="about" className="py-24 bg-gradient-to-b from-transparent to-gray-50 dark:to-gray-900">
