...
export function BlogPage(props: BlogPageProps) {
  const { articles, categories, basePath = '/insights' } = props;
            ...
            {featuredArticle && (
                <section className="mb-16">
                    <h2 className={cn(
                        ...
                        {selectedCategory === 'All' ? 'Featured' : `Latest in ${selectedCategory}`}
                    </h2>
                    <motion.div
                    ...
                    >
                        <ArticleCard article={featuredArticle} variant="featured" basePath={basePath} />
                    </motion.div>
                </section>
            )}
